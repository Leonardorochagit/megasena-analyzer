...
VERSOES_ESTRATEGIAS = {
    ...
    'ensemble': {
        'versao': '3.1',
        'nota': 'Ensemble por decisao: combina backtesting longo, sena/quina/quadra, consistencia por concurso e penalidade por repeticao; streak recente remove apenas estrategias explicitamente frias',
    },
    'sequencias': {
        'versao': '1.1',
